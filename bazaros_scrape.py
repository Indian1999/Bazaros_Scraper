...
num_of_products = remove_non_digit(driver.find_element(By.CSS_SELECTOR, "span.mainbox-title__right").text)
num_of_pages = math.ceil(num_of_products / 50)


driver = webdriver.Chrome(options = options)

driver.get("https://bazarosonline.hu/alex-store-hu/?page=1")
